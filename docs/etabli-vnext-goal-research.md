...
- Un montant explicite pour `LIVE_EVAL_BUDGET_USD` est nécessaire avant de lancer les répétitions live payantes. Sans lui, le goal peut livrer les gates déterministes mais doit rester **blocked: live effectiveness not verified** pour la claim vNext complète.

## Validation de cet artefact

- `scripts/research-proof-check docs/etabli-vnext-goal-research.md`: **passed**.
- `scripts/answer-quality-check --mode research docs/etabli-vnext-goal-research.md`: **passed**.
- `scripts/answer-quality-check --mode repo docs/etabli-vnext-goal-research.md`: **passed**.
