...
Historical audit `docs/archive/etabli-harness-audit-20260724.md` listed P0s that **adversary-10 closed**:
...
Scorecard: `docs/archive/adversary-etabli-10-scorecard.md` — all dimensions ≥9, High/Critical = 0.
...
| Artifact | Role |
| --- | --- |
| `docs/archive/adversary-etabli-10-scorecard.md` | Residual lows + dimension scores |
| `docs/archive/adversary-etabli-10-baseline.md` | Pre-slice P1 list |
| `docs/plan/20260729-etabli-adversary-10.md` | What just shipped |
| `docs/archive/etabli-harness-audit-20260724.md` | Historical map (partially stale P0s) |
