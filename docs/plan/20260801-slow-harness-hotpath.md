...
- Mac mini `/Volumes/Crucial/work/etabli/.workflow`: 50 ledgers, 1,215 events, about 1.4 MB, and one historical `etabli-vnext-proved` ledger invalid only because events followed a terminal event.
