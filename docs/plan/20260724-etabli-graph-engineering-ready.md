...
- Multi-hop fixture vault + smokes; ≥2 vNext tasks (one-hop, stale-label, hops=2).
...
- Harness scorecard: verify-agentic-infra all, vNext 35/35, capabilities honest, git diff --check.
...
- Next links: workflow/vnext/results/expand-decision.txt; tests/fixtures/action-graph.tsv
