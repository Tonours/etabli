...
- vNext already supplies frozen final-state and sealed held-out evidence; it
  was retained rather than duplicated or weakened.
- The starting worktree contained unrelated graph, vNext, installer, and
...
- `bash tests/workflow-docs-smoke.sh`
  - result: passed.
- `bash tests/vnext-suite-smoke.sh`
  - result: passed.
