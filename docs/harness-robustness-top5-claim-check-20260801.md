...
| A4 | Les held-out  marked sealed sont publics dans le worktree | `git ls-files workflow//tasks.json`; `jq` compte 13 entrées `split=held_out && sealed=true` | **confirmed** |
