...
3. **Load practice skills** for the matched domain only:
   ...
   | -------- | ----------------- |
   | TypeScript / implementation | `codebase-design` (vendored, matt pocock); pstack principles via the pi-pstack port (type-system-discipline, subtract-before-you-add, prove-it-works) |
