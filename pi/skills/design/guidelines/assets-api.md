...
- `emerald-mist`: deep employer green and dark moss in the upper left flowing through a vibrant sage and misty lime transition then settling into a soft eucalyptus and pale silver-grey at the lower right
...
- `employer`: misty pine employer valley — sage greens, cool grays, muted blue-green
...
- `lake`: still lake at twilight with employered shoreline — deep slate blue, muted teal, soft peach undertones
