...
1. **Project suites** — employer Ember / employer backend / Adonis / TanStack Start tasks → prefer `ember-employer-suite`, `employer-backend-suite`, `adonisjs-suite`, or `tanstack-start-suite` over generic suites.
