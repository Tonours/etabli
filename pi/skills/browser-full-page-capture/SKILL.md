...
Use the local helper when Playwright and `ffmpeg` are available (script
paths are relative to this skill's directory):

```bash
node scripts/stitch-full-page-capture.mjs \
...
```bash
node --check scripts/stitch-full-page-capture.mjs
