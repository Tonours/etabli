...
map("n", "<leader>ri", function()
  require("config.review.hunk_flow").open_inbox()
end, vim.tbl_extend("force", opts, { desc = "Hunk review inbox" }))
map("n", "<leader>rh", function()
  require("config.review.hunk_flow").show_current_hunk()
end, vim.tbl_extend("force", opts, { desc = "Focus current line in Hunk" }))
map("n", "<leader>ra", function()
  require("config.review.hunk_flow").annotate_current_hunk()
end, vim.tbl_extend("force", opts, { desc = "Add Hunk review comment" }))
map("x", "<leader>ra", function()
  require("config.review.hunk_flow").annotate_visual_selection()
end, vim.tbl_extend("force", opts, { desc = "Add Hunk review range comment" }))
map("n", "<leader>rs", function()
  require("config.review.hunk_flow").sync_hunk("pull")
end, vim.tbl_extend("force", opts, { desc = "Persist Hunk review notes" }))
map("n", "<leader>rn", function()
  require("config.review.hunk_flow").navigate_hunk_comment("next")
end, vim.tbl_extend("force", opts, { desc = "Next Hunk review comment" }))
map("n", "<leader>rN", function()
  require("config.review.hunk_flow").navigate_hunk_comment("prev")
end, vim.tbl_extend("force", opts, { desc = "Previous Hunk review comment" }))
map("n", "<leader>rH", function()
  require("config.review.hunk_flow").open_hunk()
end, vim.tbl_extend("force", opts, { desc = "Open Hunk review viewer" }))
map("n", "<leader>r?", function()
  require("config.review.hunk_flow").show_help()
end, vim.tbl_extend("force", opts, { desc = "Hunk review help" }))
map("n", "<leader>rx", function()
  require("config.review.hunk_flow").open_context_rail()
end, vim.tbl_extend("force", opts, { desc = "Hunk context rail" }))
map("n", "<leader>rc", function()
  require("config.review.hunk_flow").prepare_review("claude")
end, vim.tbl_extend("force", opts, { desc = "Claude Hunk review pass" }))
map("n", "<leader>rp", function()
  require("config.review.hunk_flow").prepare_review("pi")
end, vim.tbl_extend("force", opts, { desc = "Pi Hunk review pass" }))
...
local legacy_review_keymaps = vim.g.etabli_review_legacy_keymaps
if legacy_review_keymaps == true or legacy_review_keymaps == 1 or legacy_review_keymaps == "1" then
  map("n", "<leader>rr", function()
    require("config.review").resolve_current_comment()
  end, vim.tbl_extend("force", opts, { desc = "Legacy resolve review conversation" }))
  map("n", "<leader>rs", function()
    require("config.review").select_current_status()
  end, vim.tbl_extend("force", opts, { desc = "Legacy set review status" }))
  map("n", "<leader>rA", function()
    require("config.review").accept_current_hunk()
  end, vim.tbl_extend("force", opts, { desc = "Legacy accept current hunk" }))
  map("n", "<leader>rV", function()
    require("config.review").mark_current_reviewed(true)
  end, vim.tbl_extend("force", opts, { desc = "Legacy mark current hunk reviewed" }))
  map("n", "<leader>rt", function()
    require("config.review").start_transaction()
  end, vim.tbl_extend("force", opts, { desc = "Legacy start review transaction" }))
  map("n", "<leader>rT", function()
    require("config.review").preview_transaction()
  end, vim.tbl_extend("force", opts, { desc = "Legacy preview review transaction" }))
  map("n", "<leader>rl", function()
    require("config.review").cmd_inline_annotations({ args = "toggle" })
  end, vim.tbl_extend("force", opts, { desc = "Legacy toggle inline annotations" }))
  map("n", "<leader>ro", function()
    require("config.review").cmd_inline_annotations({ args = "expand" })
  end, vim.tbl_extend("force", opts, { desc = "Legacy open inline review thread" }))
  map("n", "<leader>rg", function()
    require("config.review").compare_current_agents()
  end, vim.tbl_extend("force", opts, { desc = "Legacy compare agent findings" }))
  map("n", "<leader>rS", function()
    require("config.review").preview_current_suggestion()
  end, vim.tbl_extend("force", opts, { desc = "Legacy preview suggested change" }))
  map("n", "<leader>rC", function()
    require("config.review").send_current("claude", "explain")
  end, vim.tbl_extend("force", opts, { desc = "Legacy Claude explain hunk" }))
  map("n", "<leader>rP", function()
    require("config.review").send_current("pi", "explain")
  end, vim.tbl_extend("force", opts, { desc = "Legacy Pi explain hunk" }))
  map("n", "<leader>rbc", function()
    require("config.review").prepare_batch("claude", "needs-rework")
  end, vim.tbl_extend("force", opts, { desc = "Legacy Claude batch rework" }))
  map("n", "<leader>rbp", function()
    require("config.review").prepare_batch("pi", "needs-rework")
  end, vim.tbl_extend("force", opts, { desc = "Legacy Pi batch rework" }))
end
