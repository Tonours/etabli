...
map("n", "<leader>pa", function()
  require("config.ade").show_status()
end, vim.tbl_extend("force", opts, { desc = "ADE status" }))
map("n", "<leader>pA", function()
  require("config.ade").resume()
end, vim.tbl_extend("force", opts, { desc = "ADE resume" }))
map("n", "<leader>pn", function()
  require("config.ade").show_next()
end, vim.tbl_extend("force", opts, { desc = "ADE next" }))
map("n", "<leader>pd", function()
  require("config.ade").show_doctor()
end, vim.tbl_extend("force", opts, { desc = "ADE doctor" }))
map("n", "<leader>pf", function()
  require("config.ade").refresh_review()
end, vim.tbl_extend("force", opts, { desc = "ADE refresh review" }))
map("n", "<leader>pm", function()
  require("config.ade").show_mode()
end, vim.tbl_extend("force", opts, { desc = "ADE mode" }))
map("n", "<leader>po", function()
  require("config.ade").open_plan()
end, vim.tbl_extend("force", opts, { desc = "ADE open plan" }))
map("n", "<leader>ph", function()
  require("config.ade").open_handoff()
end, vim.tbl_extend("force", opts, { desc = "ADE handoff" }))
map("n", "<leader>pR", function()
  require("config.ade").open_review()
end, vim.tbl_extend("force", opts, { desc = "ADE review" }))
