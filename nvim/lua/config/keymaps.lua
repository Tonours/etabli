...
end, vim.tbl_extend("force", opts, { desc = "Mark current hunk reviewed" }))
map("n", "<leader>rt", function()
  require("config.review").start_transaction()
end, vim.tbl_extend("force", opts, { desc = "Start review transaction" }))
map("n", "<leader>rT", function()
  require("config.review").preview_transaction()
end, vim.tbl_extend("force", opts, { desc = "Preview review transaction" }))
...
end, vim.tbl_extend("force", opts, { desc = "Preview suggested review change" }))
map("n", "<leader>rH", function()
