...
4. Review only the target scope.
5. Report concise findings with severity, file/line, why it matters, and the smallest fix.
6. End with exactly one verdict: `GO`, `GO WITH NOTES`, or `BLOCK`.
