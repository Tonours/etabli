---
name: ember-employer-architecture
description: "Work inside employer’s hybrid Ember architecture: features, shared, routes, data, legacy fallback, and MFEs."
version: 0.2.0
author: employer Team
license: Proprietary
---

# Ember employer Architecture

Use this skill when deciding where code belongs or reviewing an architectural change.

## Mental model

employer is a hybrid Ember app migrating away from legacy pods toward feature-first modules.
