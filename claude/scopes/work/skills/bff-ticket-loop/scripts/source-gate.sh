...
check_readonly_repo "$HOME/work/forestadmin-server" "forestadmin-server"
check_readonly_repo "$HOME/work/forestadmin-bugfixes" "forestadmin-bugfixes"
check_readonly_repo "$HOME/work/zendesk/forest-for-zendesk" "forest-for-zendesk"
