---
name: ember-forestadmin-workflow-visualizer
description: "Work safely inside ForestAdmin workflow visualizer: orchestrator/executor split, state, services, and step UI."
version: 0.2.0
author: ForestAdmin Team
license: Proprietary
---

# Ember ForestAdmin Workflow Visualizer
...
- Orchestrator: Forest server, owns state machine, workflow history, step definitions, and sees outcome metadata only.
...
APIs:
- Orchestrator: `/api/workflow-orchestrator`, Forest JWT, start/resume/continue/revise/abort runs.
- Executor: `/forest/_internal/workflow-executions`, proxied Forest JWT, wake executor/fetch step result data.
