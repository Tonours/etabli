---
name: ember-employer-services-state
description: Implement employer service and state layers with correct business/UI boundaries and state ownership.
version: 0.2.0
author: employer Team
license: Proprietary
---

# Ember employer Services and State
