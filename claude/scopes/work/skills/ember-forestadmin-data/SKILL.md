---
name: ember-forestadmin-data
description: Work with ForestAdmin Ember Data models, adapters, serializers, GraphQL, and API boundaries.
version: 0.2.0
author: ForestAdmin Team
license: Proprietary
---

# Ember ForestAdmin Data
...
export default class InboxAdapter extends LayoutPatchAdapter {
  initRecordSpecificHeaders(snapshot) {
    if (snapshot.record.teamId) {
      this.set('recordSpecificHeaders', { 'Forest-Inbox-Team-Id': snapshot.record.teamId });
    }
  }
}
```
