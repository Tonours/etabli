---
name: ember-forestadmin-react-mfe
description: Build React 19 Module Federation micro-frontends hosted inside the ForestAdmin Ember app.
version: 0.2.0
author: ForestAdmin Team
license: Proprietary
---

# Ember ForestAdmin React MFE
...
`@forest-admin/mfe-hmr` exists because standard HMR context is lost when an MFE is loaded through Module Federation into Ember.
...
React packages use `@forest-admin/config`:
...
- TanStack Query through `@forest-admin/data` helpers when server state is involved.
