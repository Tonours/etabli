...
|-------|------------|-------|
| frontend | employer/employer | Ember.js 4.12 Octane, TypeScript 5.9, SCSS, Module Federation (React MFEs) |
| backend | employer/employer-server | Node.js 22.12.0, TypeScript, Express, Sequelize, Elasticsearch, BullMQ |
| agent | employer/agent-nodejs | Node.js, TypeScript, Monorepo |
| zendesk | employer/employer-for-zendesk | React 18, TypeScript, Vite, Zendesk Garden |
