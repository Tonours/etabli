---
name: spec
description: Write, structure or revise Forest specs, tech specs, Epics and design docs using its two templates. Use for /spec or spec-writing requests.
---

# Création de spec Forest

Rédiger une spec Forest qui tient les standards : le format réel de l'équipe (Linear) + les bonnes pratiques design-doc de l'industrie (Google, RFC, ADR). Le but d'une spec, c'est de **récolter du feedback AVANT de construire** — pas de documenter après coup.

## Deux niveaux, ne pas confondre

Forest sépare deux docs. Identifie lequel on écrit AVANT de commencer.
