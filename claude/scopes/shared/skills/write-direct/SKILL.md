...
- Trop francisé « D'abord le faire fonctionner, ensuite correctement, puis l'améliorer. » → anglicismes assumés « First do it, then do it right, then make it better. On rewrite `forest-client.ts` from scratch. »
