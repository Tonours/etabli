...
3. **Verbes directs et imagés** (vérifiés sur mes messages) : "virer", "creuser" ("on creuse d'abord
   ...
   (= joindre : "ça vient pas taper sur api.forestadmin.com"), "filer" (= donner), "remonter", "mitiger",
...
`forest-client.ts` from scratch, et on dédoublonne la logique en phase finale. »
