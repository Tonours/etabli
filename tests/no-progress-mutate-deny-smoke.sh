...
function writePlan(status) {
  writeFileSync(
    ...
    [
      ...
      "",
      "## Goal",
      "Exercise the no-progress mutation guard.",
      "",
      "## Workflow Contract",
      "- Router decision: implement",
      "- Role: implementer",
      "- Stop condition: assertions pass",
      "- Required evidence: guard decisions",
      "",
      "## Acceptance Criteria",
      "- [ ] Guard decisions match the fixture.",
      "",
      "## Scope",
      "- Synthetic fixture only.",
      "",
      "## Facts And Assumptions",
      "- The ledger is synthetic.",
      "",
      "## Requirement Trace",
      "- Request -> synthetic ledger -> no material gap -> guard decision.",
      "",
      "## Steps",
