...
harness_require_unchanged uncommitted scripts/writable-helper.sh
harness_require_only_paths scripts/writable-helper.sh PLAN.md
harness_require_tables
harness_require_verdict GO 'GO WITH NOTES' BLOCK
