...
assert_link "$HOME_DIR/.claude/skills/vercel-react-best-practices" "$ROOT_DIR/vendor/vercel-agent-skills/skills/react-best-practices"
...
assert_absent "$HOME_DIR/.claude/skills/ember-forestadmin-suite"
...
assert_link "$HOME_DIR/.codex/skills/vercel-react-best-practices" "$ROOT_DIR/vendor/vercel-agent-skills/skills/react-best-practices"
...
assert_link "$HOME_DIR/.pi/agent/skills/vercel-react-best-practices" "$ROOT_DIR/vendor/vercel-agent-skills/skills/react-best-practices"
