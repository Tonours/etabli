...
writeLedger("etabli-vnext-proved", [
  event("etabli-vnext-proved", "completed", { summary: "historical done" }),
  event("etabli-vnext-proved", "validation_run", { command: "post-terminal", exit: 0 }),
]);
