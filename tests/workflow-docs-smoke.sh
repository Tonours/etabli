...
assert_file "$ROOT_DIR/harness/templates/docs/plan.md"
...
assert_contains "$ROOT_DIR/harness/templates/docs/plan.md" 'Each archive is a distilled memory record, not a raw copy of `PLAN.md`.'
