...
assert_contains "$ROOT_DIR/workflow/events.md" '`harness_validation_completed`'
...
assert_contains "$ROOT_DIR/workflow/events.md" '`runtime_run_attached`'
...
assert_contains "$ROOT_DIR/scripts/workflow-event" 'runtime_run_attached'
...
assert_contains "$ROOT_DIR/workflow/skills/self-improvement-loop.md" 'percentage-point deltas per'
...
assert_contains "$ROOT_DIR/workflow/events.md" 'independent ledger initiatives'
...
assert_contains "$ROOT_DIR/workflow/spec.md" 'retry from `/` with an explicit'
assert_contains "$ROOT_DIR/workflow/spec.md" 'For broad external research, repo-pattern, or fresh-context review'
assert_contains "$ROOT_DIR/workflow/spec.md" 'answer `no change`,'
assert_contains "$ROOT_DIR/workflow/spec.md" 'Before mutable local-device or server actions'
...
assert_contains "$ROOT_DIR/workflow/skills/multi-model-orchestration.md" 'Output caps are'
assert_contains "$ROOT_DIR/workflow/skills/multi-model-orchestration.md" 'Do not terminate a model solely because of elapsed wall-clock time.'
assert_contains "$ROOT_DIR/workflow/skills/multi-model-orchestration.md" 'portfolio-model overrides are rejected'
...
assert_contains "$ROOT_DIR/pi/skills/plan-loop/SKILL.md" '~/.pi/agent/PLAN_TEMPLATE.md'
assert_contains "$ROOT_DIR/pi/skills/plan-loop/SKILL.md" '~/.agents/PLAN_TEMPLATE.md'
...
assert_contains "$ROOT_DIR/pi/skills/plan-implement/SKILL.md" '~/.agents/PLAN_TEMPLATE.md'
...
assert_contains "$ROOT_DIR/docs/workflow-guide.md" 'Plan-mutation'
assert_contains "$ROOT_DIR/docs/workflow-guide.md" 'plan-implement'
assert_contains "$ROOT_DIR/docs/workflow-guide.md" 'Validation ladder'
assert_contains "$ROOT_DIR/docs/workflow-guide.md" '```mermaid'
assert_contains "$ROOT_DIR/docs/workflow-guide.md" 'provider/model'
assert_contains "$ROOT_DIR/docs/cross-project-research-grounding.md" 'Pi and Claude adapters'
...
assert_contains "$ROOT_DIR/claude/commands/plan-create.md" '~/.claude/PLAN_TEMPLATE.md'
assert_contains "$ROOT_DIR/claude/commands/plan-create.md" '~/.agents/PLAN_TEMPLATE.md'
...
assert_contains "$ROOT_DIR/claude/commands/plan-loop.md" '~/.claude/PLAN_TEMPLATE.md'
assert_contains "$ROOT_DIR/claude/commands/plan-loop.md" '../PLAN_TEMPLATE.md'
assert_contains "$ROOT_DIR/claude/commands/plan-loop.md" '../../PLAN_TEMPLATE.md'
assert_contains "$ROOT_DIR/claude/commands/plan-implement.md" '~/.claude/PLAN_TEMPLATE.md'
...
assert_contains "$INSTALL_MAIN" 'npm:@agwab/pi-workflow@0.8.1'
assert_contains "$ROOT_DIR/README.md" 'workflow/pi-workflow-adapter.md'
assert_contains "$ROOT_DIR/workflow/spec.md" 'workflow/pi-workflow-adapter.md'
assert_contains "$ROOT_DIR/workflow/skills/orchestration.md" 'workflow/pi-workflow-adapter.md'
...
assert_contains "$ROOT_DIR/workflow/pi-workflow-adapter.md" 'Resource filtering reduces what Etabli loads; it does not limit'
assert_contains "$ROOT_DIR/workflow/pi-workflow-adapter.md" 'supports_named_workflow_graphs'
assert_contains "$ROOT_DIR/workflow/pi-workflow-adapter.md" 'Node.js `>=22.19.0`'
