...
assert_contains "$ROOT_DIR/scripts/install.sh" 'vscode-languageserver-protocol@3.17.5'
assert_contains "$ROOT_DIR/scripts/install.sh" 'install_pi_agent_npm_pins'
assert_contains "$ROOT_DIR/scripts/install.sh" '$HOME/.pi/agent/npm/node_modules'
...
assert_contains "$ROOT_DIR/pi/extensions/lib/workflow-router-runtime.ts" 'SELF_IMPROVEMENT_PATTERN'
assert_contains "$ROOT_DIR/pi/extensions/lib/workflow-router-runtime.ts" 'AMBITIOUS_PROJECT_PATTERN'
