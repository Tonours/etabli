...
assert_decision plan_slice next_verifiable_slice
"$EVENT_TOOL" --dir "$EVENT_DIR" append "$RUN" project_slice_planned '{"slice":"verification","owner":"verifier","validation":"scripts/vnext-suite --json --strategy baseline","dependencies":["contract"]}'
assert_decision execute_slice planned_slice_needs_evidence
...
"$EVENT_TOOL" --dir "$EVENT_DIR" append "$RUN" validation_run '{"command":"scripts/vnext-suite --json --strategy baseline","exit":0}'
...
"$EVENT_TOOL" --dir "$EVENT_DIR" append "$NO_PROGRESS_RUN" no_progress '{"check_or_hypothesis":"missing final-state evidence","command":"scripts/vnext-suite --json --strategy baseline","attempts":2,"head_sha":"deadbeef","eliminated":["claim driver completion is enough"]}'
...
"$EVENT_TOOL" --dir "$EVENT_DIR" append "$STALE_RUN" validation_run '{"command":"scripts/vnext-suite --json --strategy baseline","exit":0}'
...
"$EVENT_TOOL" --dir "$EVENT_DIR" append "$STALE_RUN" project_slice_planned '{"slice":"verification","owner":"verifier","validation":"scripts/vnext-suite --json --strategy baseline","dependencies":["contract"]}'
...
"$EVENT_TOOL" --dir "$EVENT_DIR" append "$CHECKPOINT_BYPASS_RUN" project_slice_planned '{"slice":"verification","owner":"verifier","validation":"scripts/vnext-suite --json --strategy baseline","dependencies":["contract"]}'
...
"$EVENT_TOOL" --dir "$EVENT_DIR" append "$OUT_OF_ORDER_RUN" project_slice_planned '{"slice":"verification","owner":"verifier","validation":"scripts/vnext-suite --json --strategy baseline","dependencies":[]}'
...
"$EVENT_TOOL" --dir "$EVENT_DIR" append "$MUTATION_AFTER_PROOF_RUN" project_slice_planned '{"slice":"verification","owner":"verifier","validation":"scripts/vnext-suite --json --strategy baseline","dependencies":["contract"]}'
...
"$EVENT_TOOL" --dir "$EVENT_DIR" append "$MUTATION_AFTER_PROOF_RUN" validation_run '{"command":"scripts/vnext-suite --json --strategy baseline","exit":0}'
...
"$EVENT_TOOL" --dir "$EVENT_DIR" append "$CROSS_RUN" validation_run '{"command":"scripts/vnext-suite --json --strategy baseline","exit":0}'
...
"$EVENT_TOOL" --dir "$EVENT_DIR" append "$FAILED_EVALUATION_RUN" project_slice_planned '{"slice":"verification","owner":"verifier","validation":"scripts/vnext-suite --json --strategy baseline","dependencies":["contract"]}'
...
"$EVENT_TOOL" --dir "$EVENT_DIR" append "$FAILED_EVALUATION_RUN" validation_run '{"command":"scripts/vnext-suite --json --strategy baseline","exit":0}'
...
"$EVENT_TOOL" --dir "$EVENT_DIR" append "$FAILED_EVALUATION_RUN" validation_failed '{"command":"scripts/vnext-suite --json --strategy baseline","exit":1,"failure":"latest final-state run failed"}'
