...
emit ss-ok harness_validation_completed '{"candidate":"split-review-guard","verdict":"rejected","reason":"regression","held_in":{"baseline":{"population":"etabli-vnext-initial-v1","passed":0,"total":2},"candidate":{"population":"etabli-vnext-initial-v1","passed":1,"total":2}},"held_out":{"baseline":{"population":"etabli-vnext-initial-v1","passed":4,"total":4},"candidate":{"population":"etabli-vnext-initial-v1","passed":3,"total":4}},"checks":["t"],"evidence":["e"]}'
