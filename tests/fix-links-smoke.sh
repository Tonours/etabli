...
assert_link "$TMP_HOME/.pi/agent/skills/vercel-react-best-practices" "$ROOT_DIR/vendor/vercel-agent-skills/skills/react-best-practices"
...
assert_not_exists "$TMP_HOME/.claude/skills/suite-router"
assert_link "$TMP_HOME/.claude/skills/vercel-react-best-practices" "$ROOT_DIR/vendor/vercel-agent-skills/skills/react-best-practices"
assert_not_exists "$TMP_HOME/.codex/skills/react-doctor-100"
assert_not_exists "$TMP_HOME/.codex/skills/suite-router"
assert_link "$TMP_HOME/.codex/skills/vercel-react-best-practices" "$ROOT_DIR/vendor/vercel-agent-skills/skills/react-best-practices"
