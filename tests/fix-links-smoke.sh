...
assert_link "$TMP_HOME/.claude/agents/scout.md" "$ROOT_DIR/claude/agents/scout.md"
assert_link "$TMP_HOME/.claude/agents/worker.md" "$ROOT_DIR/claude/agents/worker.md"
assert_link "$TMP_HOME/.claude/agents/reviewer.md" "$ROOT_DIR/claude/agents/reviewer.md"
