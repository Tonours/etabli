...
assert_link "$TMP_HOME/.agents/skills/browser-full-page-capture" "$ROOT_DIR/codex/skills/browser-full-page-capture"
assert_link "$TMP_HOME/.agents/skills/frontend-motion-performance" "$ROOT_DIR/codex/skills/frontend-motion-performance"
assert_link "$TMP_HOME/.agents/skills/goal-prompt-rewriter" "$ROOT_DIR/codex/skills/goal-prompt-rewriter"
assert_link "$TMP_HOME/.agents/skills/ui-reference-capture" "$ROOT_DIR/codex/skills/ui-reference-capture"
