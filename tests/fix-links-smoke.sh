...
assert_link "$TMP_HOME/.pi/agent/skills/node" "$ROOT_DIR/vendor/mcollina-skills/skills/node"
...
assert_link "$TMP_HOME/.agents/skills/conversation-retrospect" "$ROOT_DIR/pi/skills/conversation-retrospect"
assert_link "$TMP_HOME/.agents/skills/recurring-run" "$ROOT_DIR/pi/skills/recurring-run"
assert_link "$TMP_HOME/.agents/skills/runtime-skill-canary" "$ROOT_DIR/pi/skills/runtime-skill-canary"
assert_link "$TMP_HOME/.agents/skills/session-handoff" "$ROOT_DIR/pi/skills/session-handoff"
...
assert_link "$TMP_HOME/.claude/skills/css-debugging" "$ROOT_DIR/claude/scopes/shared/skills/css-debugging"
assert_link "$TMP_HOME/.claude/skills/react-doctor-100" "$ROOT_DIR/pi/skills/react-doctor-100"
assert_link "$TMP_HOME/.claude/skills/node" "$ROOT_DIR/vendor/mcollina-skills/skills/node"
assert_link "$TMP_HOME/.codex/skills/react-doctor-100" "$ROOT_DIR/pi/skills/react-doctor-100"
assert_link "$TMP_HOME/.codex/skills/node" "$ROOT_DIR/vendor/mcollina-skills/skills/node"
...
assert_link "$TMP_HOME/.pi/agent/skills/ember-forestadmin-suite" "$ROOT_DIR/vendor/ember-skills/skills/ember-forestadmin-suite"
