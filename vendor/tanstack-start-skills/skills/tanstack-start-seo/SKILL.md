...
Official Start also documents a separate **Generative Engine Optimization (GEO)** guide for LLM/assistant-facing discoverability. Use this SEO skill for classic technical SEO; open the GEO guide when the product needs AI-crawler or LLM-oriented surfaces.
