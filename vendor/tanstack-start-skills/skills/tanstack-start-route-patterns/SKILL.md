...
Prefer a protected subtree or pathless protected layout over ad hoc checks in many child pages.
This keeps authorization structure visible in the route tree.
...
Use the parent protected layout for:
- authenticated shell
- `beforeLoad`-based session gating
- shared providers/navigation for signed-in areas
