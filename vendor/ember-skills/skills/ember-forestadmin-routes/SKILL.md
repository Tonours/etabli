---
name: ember-forestadmin-routes
description: Implement ForestAdmin Ember routes, controllers, and route templates as thin URL/model adapters.
version: 0.2.0
author: ForestAdmin Team
license: Proprietary
---

# Ember ForestAdmin Routes
...
Forest narrows that baseline: routes should be thin adapters into feature services/components.
