...
- Lucid owns persistence shape (migrations-first schema classes)
- Transformers own the response shape (presentation layer)
- actions/services own multi-step business workflows
- providers and `adonisrc.ts` hooks own registration and boot wiring
