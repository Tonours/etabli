...
check_link "$HOME/.claude/handoff-template.md" "$REPO_DIR/workflow/handoff-template.md" "claude handoff template"
...
check_link "$HOME/.claude/commands/ops-status.md" "$REPO_DIR/claude/commands/ops-status.md" "claude command ops-status.md"
